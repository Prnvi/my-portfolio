...
const MainPage = () => {
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f] '>
        <div className="bg-center bg-cover h-screen  greyscale-0 " 
         style={{
            backgroundImage:
             ...
             <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full text-white ' >
                ...
                <p className='text-white py-4 max-w-[700px]'>I’m a full-stack developer specializing in building (and occasionally
